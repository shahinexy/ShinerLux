...
const Contact = () => {
  return (
    <div>
      ...
      <div
        className="bg-no-repeat bg-cover bg-center md:h-[55vh] h-[35vh]"
          ...
          <div className="bg-primary p-5 text-white space-y-6">
            <div className="grid sm:grid-cols-2 gap-5 ">
              <div>
                <p>First Name</p>
                <input
                  className='className="mt-2 px-3 py-2 w-full text-black mt-3'
                  type="text"
            ...
            <div>
              <button className="btn flex-1 w-full bg-primary text-white rounded-none md:text-xl font-semibold hover:text-primary">
                Send <AiOutlineSend />{" "}
              </button>
            </div>
          </div>
